...
* source-code/ - Folder containing the herein modified version of lucidrains' implementation of 'lightweight' GAN proposed in ICLR 2021. Credits for paper and code go to :
